...
public class ThirdTableAdapter extends RecyclerView.Adapter<ThirdTableAdapter.ViewHolder> {

    private final List<String> column1Data;
    private final List<String> column2Data;

    public ThirdTableAdapter(List<String> column1Data, List<String> column2Data) {
